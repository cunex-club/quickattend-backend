...
CREATE TABLE "event_participants" (
  ...
  CONSTRAINT "fk_event_participants_user_ref" FOREIGN KEY ("participant_ref_id") REFERENCES "users" ("ref_id") ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE "event_whitelists" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_event_whitelist_event" FOREIGN KEY ("event_id") REFERENCES "events" ("id") ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT "fk_event_whitelist_user" FOREIGN KEY ("attendee_ref_id") REFERENCES "users" ("ref_id") ON UPDATE CASCADE ON DELETE CASCADE
);
